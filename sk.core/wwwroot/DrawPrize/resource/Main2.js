...
var GamePlaying = function(e) {
    function t() {
        e.call(this), this.PrizeNum = 12, this.LoadPicNum = 0, this.WillLoadPicNum = 0, t.GameContent = this, window.ZlanLuck || (window.ZlanLuck = {}), window.ZlanLuck.LuckStart = this.LuckStart, window.ZlanLuck.LoadPrize = this.LoadPrize, window.ZlanLuck.giftCode = null, window.ZlanLuck.SetPrize = this.SetPrize, window.ZlanLuck.LuckButton && (window.ZlanLuck.LuckButton.width && (t.DIY_LOTTERY_WIDTH = window.ZlanLuck.LuckButton.width), window.ZlanLuck.LuckButton.height && (t.DIY_LOTTERY_HEIGHT = window.ZlanLuck.LuckButton.height), window.ZlanLuck.LuckButton.x && (t.DIY_LOTTERY_X = window.ZlanLuck.LuckButton.x), window.ZlanLuck.LuckButton.y && (t.DIY_LOTTERY_Y = window.ZlanLuck.LuckButton.y)), window.ZlanLuck.Award && (window.ZlanLuck.Award.width && (t.DIY_AWARD_WIDTH = window.ZlanLuck.Award.width), window.ZlanLuck.Award.minspeed && (t.MARK_CHANGE_TIMES_PER_SECOND_MIN = window.ZlanLuck.Award.minspeed), window.ZlanLuck.Award.maxspeed && (t.MARK_CHANGE_TIMES_PER_SECOND_MAX = window.ZlanLuck.Award.maxspeed), window.ZlanLuck.Award.lastpxtime && (t.LASTPXTIME = window.ZlanLuck.Award.lastpxtime)), this.panelList || (this.panelList = ["resource/assets/panel0.png", "resource/assets/panel1.png", "resource/assets/panel2.png"]), this.skinName = "GamePlayingSkin", this.init();
        var i = {
            height: 900,
            top: 0,
            left: 0,
    ...
    return n.SetPrizeSite = function(e) {
        ...
        for (var n = 0, a = i.length; a > n; n++) for (var r = 0, o = i[n].length; o > r; r++) {
            var s = i[n][r],
                d = new egret.Shape,
                l = d.graphics;
            l.lineStyle(2, 16711680, 0), l.beginFill(16777215, .8), l.drawRoundRect(0, 0, t.AWARD_WIDTH, t.AWARD_WIDTH, t.AWARD_RDS, t.AWARD_RDS), l.endFill();
            var h = new egret.TextField;
            h.text = "Load...", h.height = t.AWARD_WIDTH, h.width = t.AWARD_WIDTH, h.textAlign = "center", h.verticalAlign = "middle";
            var u = {
            ...
            d.blendMode = egret.BlendMode.ADD, d.x = u.x, d.y = u.y, h.x = u.x, h.y = u.y, h.textColor = 0, h.size = 30, t.GameContent.addChild(d), t.GameContent.addChild(h), s.gvd = d, s.gtext = h
        }
        t.LoadArr = i, t.GameContent.Pushluckbutton()
        ...
        if (e || (e = RES.getRes("awards")), e.length && (12 == e.length || 8 == e.length)) {
            ...
            for (var n = 0, s = r.length; s > n; n++) for (var d = 0, l = r[n].length; l > d; d++) {
                var h = r[n][d],
                    u = {
                        view: t.GameContent,
                        width: t.AWARD_WIDTH,
                        ...
                        com: function(e) {
                            this.view.removeChild(this.gview), this.view.removeChild(this.gtext);
                            var i = e,
            ...
            a.WillLoadPicNum = o.length, o.forEach(function(e) {
        ...
        e.btnLottery = new egret.Bitmap(RES.getRes("btnLottery")), e.btnLottery.width = t.BTN_LOTTERY_WIDTH, e.btnLottery.height = t.BTN_LOTTERY_WIDTH, t.DIY_LOTTERY_HEIGHT > 0 && (e.btnLottery.height = t.DIY_LOTTERY_HEIGHT), t.DIY_LOTTERY_WIDTH > 0 && (e.btnLottery.width = t.DIY_LOTTERY_WIDTH), e.btnLottery.x = r + t.AWARD_WIDTH + s, e.btnLottery.y = o - t.MARGIN + s, 0 != t.DIY_LOTTERY_X && (e.btnLottery.x = t.DIY_LOTTERY_X), 0 != t.DIY_LOTTERY_Y && (e.btnLottery.y = t.DIY_LOTTERY_Y), e.addChild(e.btnLottery), e.btnLottery.touchEnabled = !1
    }, n.init = function() {
        this.isStart = !1, this.panelIndex = 0, this.panelLastTime = egret.getTimer(), this.addEventListener(egret.TouchEvent.TOUCH_TAP, this.onTouchTap, this)
    }, n.childrenCreated = function() {
        e.prototype.childrenCreated.call(this), this.addEventListener(egret.Event.ENTER_FRAME, this.update, this)
        ...
        var e = t.GameContent;
        if (!e.isStart) {
            e.isStart = !0, e.btnLottery.touchEnabled = !1, window.ZlanLuck.giftCode = null, e.awardCode = null, e.markIndex || (e.markIndex = 0), e.lastTime = 0, e.awardCode = "", e.reduceOffset = 0;
            var i = e.awardArr[0][0];
            e.awardMark.x = i.x - 2, e.awardMark.y = i.y - 2
        }
    }, n.update = function() {
        ...
        if (!(i - this.lastTime < e)) {
            this.awardCode = window.ZlanLuck.giftCode, this.awardCode && ("NULL" == this.awardCode && (this.isStart = !1, this.awardMark.visible = !1), t.MARK_CHANGE_TIMES_PER_SECOND_MAX - this.reduceOffset > t.MARK_CHANGE_TIMES_PER_SECOND_MIN && (this.reduceOffset += Math.ceil(t.MARK_CHANGE_TIMES_PER_SECOND_MAX * (i - this.lastTime) / 2e3), t.MARK_CHANGE_TIMES_PER_SECOND_MAX - this.reduceOffset < t.MARK_CHANGE_TIMES_PER_SECOND_MIN && (this.reduceOffset = t.MARK_CHANGE_TIMES_PER_SECOND_MAX - t.MARK_CHANGE_TIMES_PER_SECOND_MIN))), 0 == this.lastTime ? (this.lastTime = i, this.markIndex = ++this.markIndex % this.PrizeNum) : (this.markIndex = (this.markIndex + Math.floor((i - this.lastTime) / e)) % t.AWARD_COUNT, this.lastTime = i);
            var n = this.lotteryLine[this.markIndex];
            this.awardMark.x = n.x + t.fX, this.awardMark.y = n.y + t.fY, t.MARK_CHANGE_TIMES_PER_SECOND_MAX - this.reduceOffset === t.MARK_CHANGE_TIMES_PER_SECOND_MIN && n.name === this.awardCode && (this.isStart = !1, egret.Tween.get(this.awardMark).wait(t.LASTPXTIME).set({
                visible: !1
                ...
                window.ZlanLuck && window.ZlanLuck.LuckEnd(), this.btnLottery.touchEnabled = !0
            }, this))
        }
    }, t.AWARD_COUNT = 12, t.AWARD_PANEL_X = 50, t.AWARD_PANEL_Y = 50, t.AWARD_PANEL_WIDTH = 800, t.AWARD_PANEL_HEIGHT = 800, t.ROW_NUM = 4, t.COL_NUM = 4, t.AWARD_WIDTH = 180, t.AWARD_RDS = t.AWARD_WIDTH / 5, t.BTN_LOTTERY_WIDTH = 340, t.DIY_LOTTERY_HEIGHT = 0, t.DIY_LOTTERY_WIDTH = 0, t.DIY_LOTTERY_X = 0, t.DIY_LOTTERY_Y = 0, t.DIY_PIC_NUM = 3, t.DIY_AWARD_WIDTH = 0, t.DIY_AWARD_RDS = 0, t.LASTPXTIME = 50, t.MARGIN = (t.AWARD_PANEL_WIDTH - t.AWARD_WIDTH * t.ROW_NUM) / (t.ROW_NUM + 1), t.MARK_CHANGE_TIMES_PER_SECOND_MAX = 100, t.MARK_CHANGE_TIMES_PER_SECOND_MIN = 100, t.fX = 0, t.fY = 0, t
}(eui.Component);
...
var LoadingUI = function(e) {
    ...
    return n.createView = function() {
        this.textField = new egret.TextField, this.addChild(this.textField), this.textField.y = 900, this.textField.width = 900, this.textField.height = 100, this.textField.textAlign = "center"
...
var Main = function(e) {
    function t() {
        e.apply(this, arguments), this.isThemeLoadEnd = !1, this.isResourceLoadEnd = !1
    }
    __extends(t, e);
    var i = (__define, t),
        n = i.prototype;
    return n.createChildren = function() {
        ...
        this.stage.registerImplementation("eui.IAssetAdapter", t), this.stage.registerImplementation("eui.IThemeAdapter", new ThemeAdapter), RES.addEventListener(RES.ResourceEvent.CONFIG_COMPLETE, this.onConfigComplete, this), RES.loadConfig("resource/default.res.json", "resource/")
    }, n.onConfigComplete = function(e) {
        RES.removeEventListener(RES.ResourceEvent.CONFIG_COMPLETE, this.onConfigComplete, this);
        var t = new eui.Theme("/drawprize/resource/default.thm.json", this.stage);
...
var ThemeAdapter = function() {
    ...
    return i.getTheme = function(e, t, i, n) {
        ...
        RES.addEventListener(RES.ResourceEvent.ITEM_LOAD_ERROR, r, null), RES.getResByUrl(e, a, this, RES.ResourceItem.TYPE_TEXT)
    }, e
}();
